...
def test_issue(source):
    ...
    assert \
        query_str(source, '>issue_version["redhat:987987da98798f987c", 100]#') == \
        dict(issue_version=[raw_issue_version(
            id="redhat:987987da98798f987c",
            origin="redhat",
            report_url="https://bugzilla/207065",
    ...
    assert \
        query_str(source, '>issue_version["redhat:987987da98798aa233", 10]#') == \
        dict(issue_version=[raw_issue_version(
            id="redhat:987987da98798aa233",
            origin="redhat",
            report_url="https://bugzilla/1201011",
    ...
    assert \
        query_str(source, '>issue["redhat:987987da98798aa233"]>issue_version#') == \
        dict(issue_version=[raw_issue_version(
            id="redhat:987987da98798aa233",
            origin="redhat",
            report_url="https://bugzilla/1201011",
...
def test_incident(source):
    ...
    assert \
        query_str(source, '>incident["kernelci:29871398232"]<issue_version#') == \
        dict(issue_version=[raw_issue_version(
            id="kernelci:1209203344",
            origin="kernelci",
            report_url="https://maillist/498232",
    ...
    assert \
        query_str(source, '>incident["kernelci:29871398212"]<issue_version#') == \
        dict(issue_version=[raw_issue_version(
            id="kernelci:1209203344",
            origin="kernelci",
            report_url="https://maillist/498232",
