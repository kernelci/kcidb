...
# A regular expression pattern matching permitted ID strings
ID_PATTERN = "^[a-z0-9_]+:"
    ...
    "properties": {
        "id": {
            ...
            "description":
                ...
                "system which submitted the revision, followed by a colon "
...
def inherit(data):
    ...
    Returns:
        The inherited data.
    """
    # Merge *origin and *origin_id properties into *id properties
    # pylint: disable=redefined-builtin,invalid-name
    for collection, id_pair_map in \
